...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Redirect directly to Home page and refresh navbar state
            router.push("/");
            router.refresh();
        } catch (err: any) {
    ...
    return (
        <div
            ...
            style={{
                backgroundImage: `url('https://images.unsplash.com/photo-1621416894569-0f39ed31d247?q=80&w=2800&auto=format&fit=crop')`
            }}  >
            ...
            <div className="relative z-10 w-full max-w-md p-8 bg-white/95 rounded-2xl border border-slate-200/80 shadow-2xl backdrop-blur-md text-slate-900">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        <label htmlFor="name" className="block text-base font-medium text-slate-600 mb-1">
                            Name
                        </label>
                        <input
                            id="name"
                ...
                <p className="mt-6 text-center text-sm text-slate-500">
                    ...
                    <Link href="/login" className="text-[#EC5800] hover:underline font-semibold">
                        Log In
                    </Link>
                </p>
            </div>
